...
//        .package(name: "SwiftPhoenixClient", path: "../SwiftPhoenixClient"),
        .package(url: "https://github.com/avmanager/SwiftPhoenixClient.git", .branch("feature/better-url-param-encoding")),
